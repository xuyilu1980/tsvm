            ...
            for iter = 1:10
                ...
                for s=1:length(totalEEGSignals)
                    ...
                    if strcmp(classifier_algo,'SVM')
                        ...
                        xu5 = Xu';
                        ytest5 = ytest';
                        example_file = strcat(workpath,'\tsvm\functions\svm\','train.data');
                        test_file = strcat(workpath,'\tsvm\functions\svm\','test.data');
                        model_file = strcat(workpath,'\tsvm\functions\svm\','pre.model');
                        output_file = strcat(workpath,'\tsvm\functions\svm\','pre.mat');
                    ...
                    elseif strcmp(classifier_algo,'TSVM_light')
                        ...
                        pred=tsvm_l(XX',yy4,[workpath,'\tsvm\functions\svm\'],'pre');
                        predY = sign(pred);
